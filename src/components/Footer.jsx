...
//     </a>
//     <a href="https://apps.apple.com/in/app/fiydaa-fintech-hub-by-speculit/id6475651556"
//       target="_blank"
...
//           <p>© 2024 Clearwater Capital Pvt Ltd. All rights reserved.</p>
//         </div>
//       </div>
//     </footer>
//   );
...
function Footer() {
  ...
  return (
    <footer className="mt-10 bg-white px-4 py-5 border-t border-newDarkGold lg:px-20 md:px-8 ">
