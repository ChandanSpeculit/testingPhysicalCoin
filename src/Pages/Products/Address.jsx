                ...
                <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                        ...
                        <div class=" w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                            ...
                            <div class="space-y-3">
                                <button
                                    onClick={() => { testingPhysicalOrderLambda() }} class="flex w-full font-poppins items-center justify-center rounded-lg bg-gradient-to-r from-newDarkBlue via-newLightBlue to-newDarkBlue px-5 py-2.5 text-sm font-medium text-newDarkGold hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Proceed to Payment
                                </button>
